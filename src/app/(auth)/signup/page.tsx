...
export default function SignupPage() {
  ...
  function handlePasswordChange(value: string) {
    ...
    if (confirmPassword.length > 0) {
      setConfirmError(value !== confirmPassword ? "Passwords don't match" : null);
    }
  }

  function handleConfirmChange(value: string) {
    setConfirmPassword(value);
    setConfirmError(value !== password ? "Passwords don't match" : null);
  }
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full px-3.5 py-2.5 bg-muted border rounded-lg text-foreground placeholder-muted-foreground text-sm focus:outline-none focus:ring-1 transition-all duration-150 ${
